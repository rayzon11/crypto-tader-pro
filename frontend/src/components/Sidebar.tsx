...
const NAV_ITEMS = [
  ...
  { href: "/dashboard", label: "Dashboard", icon: "M4 6h16M4 12h16M4 18h7" },
  { href: "/crypto-predictions", label: "Crypto Predictions", icon: "M9 19V6l12-3v13M9 19c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zm12-3c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zM9 10l12-3" },
  { href: "/autonomous-trader", label: "Autonomous Trader", icon: "M13 10V3L4 14h7v7l9-11h-7z M9 12h6" },
  { href: "/futures", label: "Futures (Leverage)", icon: "M3 3v18h18M7 12l4-4 4 4 6-6" },
  { href: "/professional-trading", label: "Professional Trading", icon: "M13 10V3L4 14h7v7l9-11h-7z" },
  ...
  { href: "/charts", label: "Charts", icon: "M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" },
  ...
  { href: "/quant", label: "Quant Desk", icon: "M3 3v18h18M7 17l4-8 4 4 6-10" },
  ...
  { href: "/listings", label: "Memes · IPO · Launches", icon: "M13 10V3L4 14h7v7l9-11h-7z" },
...
export default function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-16 lg:w-56 bg-slate-900 border-r border-slate-800 z-50 flex flex-col overflow-hidden">
      {/* Logo */}
      ...
      {/* Navigation */}
      <nav className="flex-1 p-2 space-y-1 overflow-y-auto overflow-x-hidden scrollbar-thin scrollbar-thumb-slate-700 scrollbar-track-transparent" style={{ scrollbarWidth: "thin" }}>
