...
async function tradingLoop() {
  ...
  try {
    ...
    // 10. Ask AI Brain for AGI-level decision
    console.log('Requesting decision from AI Brain (AGI mode)...');
    const decision = await aiBrain.makeDecision(
      marketData,
...
// ─── Start Server ───
const futurePricePredictor = require('./services/futurePricePredictor');
futurePricePredictor.start();
